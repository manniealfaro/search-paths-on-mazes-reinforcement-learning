 ...
 */
public class Track2 extends ShapeTrack {
	...
	public Track2() {
		...
		interior.addPoint(xOff+250,yOff+450);
		interior.addPoint(xOff+375,yOff+300);
		interior.addPoint(xOff+625,yOff+300);
		interior.addPoint(xOff+750,yOff+450);
		...
		inferior.addPoint(xOff+350,yOff+600);
		inferior.addPoint(xOff+475,yOff+450);
		inferior.addPoint(xOff+525,yOff+450);
		inferior.addPoint(xOff+650,yOff+600);
		add (inferior);	
		...
		Vector2d[] points = {  new Vector2d(xOff+75,yOff+400),  new Vector2d(xOff+200,yOff+525), 
							  new Vector2d(xOff+250,yOff+525), new Vector2d(xOff+375,yOff+450), new Vector2d(xOff+475,yOff+375),
							  new Vector2d(xOff+525,yOff+375), new Vector2d(xOff+625,yOff+450), new Vector2d(xOff+750,yOff+525),
